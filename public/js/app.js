...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_wowjs__ = __webpack_require__("./node_modules/wowjs/dist/wow.js");
...
__webpack_require__("./resources/assets/js/libs/jquery.SuperSlide.2.1.1.js");
__webpack_require__("./resources/assets/js/libs/lib.js");
__webpack_require__("./resources/assets/js/libs/slick.min.js");
__webpack_require__("./resources/assets/js/libs/headroom.min.js");
__webpack_require__("./resources/assets/js/libs/jQuery.headroom.js");
// require('wowjs');
// window.WOW = require('wowjs').WOW;


window.WOW = __WEBPACK_IMPORTED_MODULE_0_wowjs__["WOW"];

__webpack_require__("./resources/assets/js/libs/public.js");
...
/***/ "./resources/assets/js/libs/headroom.min.js":
/***/ (function(module, exports) {
...
!function (a, b) {
  ...
  function c(a) {
    ...
    if (arguments.length <= 0) throw new Error("Missing arguments in extend function");var b,
        c,
        e = a || {};for (c = 1; c < arguments.length; c++) {
      var f = arguments[c] || {};for (b in f) {
    ...
    b = d(b, e.options), this.lastKnownScrollY = 0, this.elem = a, this.debouncer = new c(this.update.bind(this)), this.tolerance = b.tolerance, this.classes = b.classes, this.offset = b.offset, this.initialised = !1, this.onPin = b.onPin, this.onUnpin = b.onUnpin, this.onTop = b.onTop, this.onNotTop = b.onNotTop;
  }var f = { bind: !!function () {}.bind, classList: "classList" in b.documentElement, rAF: !!(a.requestAnimationFrame || a.webkitRequestAnimationFrame || a.mozRequestAnimationFrame) };a.requestAnimationFrame = a.requestAnimationFrame || a.webkitRequestAnimationFrame || a.mozRequestAnimationFrame, c.prototype = { constructor: c, update: function update() {
      ...
      var b = this.classes;this.initialised = !1, a.removeEventListener("scroll", this.debouncer, !1), this.elem.classList.remove(b.unpinned, b.pinned, b.top, b.initial);
      ...
      var b = 0 > a,
          c = a + this.getViewportHeight() > this.getDocumentHeight();return b || c;
      ...
      var a = this.getScrollY(),
          b = this.toleranceExceeded(a);this.isOutOfBounds(a) || (a <= this.offset ? this.top() : this.notTop(), this.shouldUnpin(a, b) ? this.unpin() : this.shouldPin(a, b) && this.pin(), this.lastKnownScrollY = a);
    } }, e.options = { tolerance: 0, offset: 0, classes: { pinned: "headroom--pinned", unpinned: "headroom--unpinned", top: "headroom--top", notTop: "headroom--not-top", initial: "headroom" } }, e.cutsTheMustard = "undefined" != typeof f && f.rAF && f.bind && f.classList, a.Headroom = e;
}(window, document);

/***/ }),

/***/ "./resources/assets/js/libs/jQuery.headroom.js":
/***/ (function(module, exports) {
...
/***/ "./resources/assets/js/libs/jquery.SuperSlide.2.1.1.js":
/***/ (function(module, exports) {
...
/***/ "./resources/assets/js/libs/lib.js":
/***/ (function(module, exports) {
...
/***/ "./resources/assets/js/libs/public.js":
/***/ (function(module, exports) {
...
__webpack_require__("./node_modules/wowjs/dist/wow.js");
